<div style="margin: auto; max-width: 500px;">
    ...
    <?php if (isset($qr_code)) { ?>
        <script id="seqrShop"
                src="https://cdn.seqr.com/webshop-plugin/js/seqrShop.js#!<?php echo ($test ? 'mode=demo&' : ''); ?>injectCSS=false&statusCallback=statusUpdated&invoiceQRCode=<?php echo $qr_code; ?>&statusURL=<?php echo $url_poll; ?>">
        </script>
    <?php } else
